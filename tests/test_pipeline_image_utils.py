...
class TestPreprocessImage:
    ...
    def test_preprocess_image_with_resize(self, sample_image):
        ...
        # 실제로는 _load_scoring_config가 없으므로 테스트 건너뜀
        pytest.skip("Requires _load_scoring_config from scoring module")
...
class TestPostprocessImage:
    ...
    def test_postprocess_image_disabled(self, sample_image):
        """후처리 비활성화 테스트"""
        # ConfigManager가 없으므로 테스트 건너뜀
        pytest.skip("Requires ConfigManager from config module")
