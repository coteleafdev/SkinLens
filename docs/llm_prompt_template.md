...
**참고**: 18개 사용자 표현용 측정항목 → 14개 처방 항목(A01-A14) 매핑입니다.
...
- M10: 피부결 (roughness_score) - AHA, 효소, 각질 제거 성분
- M14: 여드름 (acne_score) - 살리실산, 티트리 오일, 나이아신아마이드 성분
