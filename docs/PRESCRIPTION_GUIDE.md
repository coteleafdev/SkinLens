...
flowchart TD
    ...
    Step1 --> Q1{피부타입 선택}
    Q1 --> |지성| Type1[M04 유분 조절 믹스]
    Q1 --> |건성| Type2[M13 수분 케어 믹스]
    Q1 --> |복합성| Type3[M04 + M13 혼합]
    Q1 --> |민감성| Type4[M13 수분 케어 믹스]
...
| 카테고리 | 측정항목 | 믹스 코드 | 설명 |
|----------|----------|----------|------|
| 톤·밝기 | skin_tone_score, dullness_score, uneven_tone_score | M01 | 광채 |
| 주름 | eye_wrinkle_score, nasolabial_wrinkle_score, fine_deep_wrinkle_score | M02 | 주름 |
| 탄력 | jawline_blur_score, cheek_sagging_score | M05 | 탄력 |
