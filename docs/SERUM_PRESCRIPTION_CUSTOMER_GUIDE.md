...
|---------|---------|---------|---------|------------------|------------|
| **지성** | 지성용 믹스 | M04 | 니아신아마이드, 레스베라트롤, 티트리 오일 | 피지 과다 분비를 조절하고 모공을 수축하며 항균 작용으로 트러블 예방 | 2% |
| **건성** | 건성용 믹스 | M13 | 히알루론산, 세라마이드, 스쿠알란 | 피부에 수분을 공급하고 보습막을 형성하여 피부 장벽을 강화 | 2% |
| **복합성** | 복합용 믹스 | M04 + M13 | 판테놀, 알란토인, 글리콜산 | 유분과 수분 밸런스를 조절하고 피부를 진정하며 부드럽게 각질 제거 | 2% (M04 1% + M13 1%) |
| **민감성** | 민감용 믹스 | M13 | 시카 추출물, 알로에 베라, 비타민 E | 민감한 피부를 진정하고 항염 작용으로 피부를 보호 | 2% |
...
| M04 | 유분 조절 믹스 | oiliness | 유분 관리 | ✅ 사용 중 (피부 타입 기반) |
...
| M13 | 수분 케어 믹스 | moisture | 수분 관리 | ✅ 사용 중 (피부 타입 기반) |
...
- **M01**: 광채 케어 믹스 (톤 & 밝기)
- **M02**: 주름 케어 믹스 (주름)
- **M04**: 유분 조절 믹스 (유분 관리 - 피부 타입 기반)
- **M05**: 탄력 케어 믹스 (탄력 & 처짐)
- **M06**: 색소 케어 믹스 (색소침착)
- **M07**: 홍조 케어 믹스 (홍조·혈관)
- **M09**: 모공 케어 믹스 (모공)
- **M10**: 피부결 케어 믹스 (피부결)
- **M13**: 수분 케어 믹스 (수분 관리 - 피부 타입 기반)
- **M14**: 트러블케어 믹스 (여드름 & 흔적)
