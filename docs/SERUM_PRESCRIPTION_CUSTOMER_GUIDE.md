...
- **활성 믹스 10종 (M01-M10)**: 피부 평가 점수 기반 처방
  - **현재 사용 중인 믹스 10종**: 광채(M01), 주름(M02), 유분 조절(M03), 탄력&처짐(M04), 색소침착(M05), 홍조(M06), 모공(M07), 피부결(M08), 수분 케어(M09), 여드름(M10)
...
| M03 | 유분 조절 믹스 | oiliness | 유분 관리 | ✅ 사용 중 (피부 타입 기반) |
...
| M09 | 수분 케어 믹스 | moisture | 수분 관리 | ✅ 사용 중 (피부 타입 기반) |
...
- **M01**: 광채 케어 믹스 (톤 & 밝기)
- **M02**: 주름 케어 믹스 (주름)
- **M03**: 유분 조절 믹스 (유분 관리 - 피부 타입 기반)
- **M04**: 탄력&처짐 케어 믹스 (탄력 & 처짐)
- **M05**: 색소 케어 믹스 (색소침착)
- **M06**: 홍조 케어 믹스 (홍조·혈관)
- **M07**: 모공 케어 믹스 (모공)
- **M08**: 피부결 케어 믹스 (피부결)
- **M09**: 수분 케어 믹스 (수분 관리 - 피부 타입 기반)
- **M10**: 트러블케어 믹스 (여드름 & 흔적)
