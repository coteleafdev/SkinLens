...
### 📄 최상위 문서 (Top-Level Documents)

| 파일 | 설명 | 대상 |
|------|------|------|
| [ARCHITECTURE.md](guides/ARCHITECTURE.md) | **아키텍처 (최상위)** | 모든 사용자 |
| [PROTOCOL.md](guides/PROTOCOL.md) | **시스템 프로토콜 (최상위)** | 개발자, DevOps |
| [API_REFERENCE.md](api/API_REFERENCE.md) | **REST API 엔드포인트 상세 (최상위)** | 개발자 |
...
API 문서는 최상위 문서 섹션의 [API_REFERENCE.md](api/API_REFERENCE.md)를 참조하세요.
...
| 파일 | 설명 | 대상 |
|------|------|------|
| [ARCHITECTURE.md](guides/ARCHITECTURE.md) | 아키텍처, 전략 패턴 | 개발자 |
| [PROTOCOL.md](guides/PROTOCOL.md) | 시스템 프로토콜 | 개발자, DevOps |
...
| [SKIN_ANALYSIS_PIPELINE_GUIDE.md](user/SKIN_ANALYSIS_PIPELINE_GUIDE.md) | 피부 분석 파이프라인 가이드 (GUI) | 최종 사용자 |
...
#### 🆕 새로운 개발자
1. [ARCHITECTURE.md](guides/ARCHITECTURE.md) - **아키텍처 이해 (최상위 문서)**
2. [PROTOCOL.md](guides/PROTOCOL.md) - **통신 프로토콜 이해 (최상위 문서)**
3. [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md) - 프로젝트 전체 이해
4. [DEVELOPMENT_GUIDE.md](guides/DEVELOPMENT_GUIDE.md) - 개발 환경 설정
5. [API_REFERENCE.md](api/API_REFERENCE.md) - API 사용 방법
6. [EXTERNAL_SYSTEM_INTEGRATION_GUIDE.md](EXTERNAL_SYSTEM_INTEGRATION_GUIDE.md) - 외부 시스템 연동
7. [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md#314-버전-관리) - 버전 관리 정책

#### 🔧 DevOps 엔지니어
1. [PROTOCOL.md](guides/PROTOCOL.md) - **통신 프로토콜 이해 (최상위 문서)**
2. [ARCHITECTURE.md](guides/ARCHITECTURE.md) - **아키텍처 이해 (최상위 문서)**
3. [DEPLOYMENT_GUIDE.md](ops/DEPLOYMENT_GUIDE.md) - 배포 방법
4. [LINUX_DOCKER_DEPLOYMENT.md](ops/LINUX_DOCKER_DEPLOYMENT.md) - Docker 상세 배포
5. [SECURITY_GUIDE.md](ops/SECURITY_GUIDE.md) - 보안 설정
6. [TROUBLESHOOTING_GUIDE.md](ops/TROUBLESHOOTING_GUIDE.md) - 문제 해결
7. [EXTERNAL_SYSTEM_INTEGRATION_GUIDE.md](EXTERNAL_SYSTEM_INTEGRATION_GUIDE.md) - 외부 시스템 연동
